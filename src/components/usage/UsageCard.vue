...
.usage-card__percentage {
  display: block; margin-top: 8px; color: var(--app-white); font-size: 1.1rem;
...
.usage-card__title { margin: 6px 0 0; color: var(--app-white); font-size: 0.81rem; font-weight: 600; line-height: 1.3; }
.usage-card__reset { margin: 4px 0 0; color: var(--app-text-secondary); font-size: 0.7rem; line-height: 1.35; }
</style>
